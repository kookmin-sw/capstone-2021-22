...
exports.recase = exports.qNameJoin = exports.qNameSplit = exports.TableData = void 0;
...
function recase(opt, val, singularize = false) {
    if (singularize && val) {
        val = sequelize_1.Utils.singularize(val);
    }
    if (!opt || opt === 'o' || !val) {
        return val || ''; // original
    }
